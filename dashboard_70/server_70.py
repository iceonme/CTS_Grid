...
class DashboardServer70:
    ...
    def __init__(self, host='0.0.0.0', port=5070):
        self.host = host
        self.port = port
    ...
    def _setup_routes(self):
        ...
        self.version = "v7.0-Razor-Dashboard"
        ...
        def api_status():
            ...
            if strategy_id:
                data = self._data.get(strategy_id, DashboardServer70._EMPTY_STRATEGY_DATA())
    ...
    def _setup_socketio(self):
        ...
        def handle_join(data):
            ...
            existing = self._data.get(strategy_id, DashboardServer70._EMPTY_STRATEGY_DATA())
    ...
    def register_strategy(self, strategy_id: str, display_name: str = None):
        if strategy_id not in self._data:
            self._data[strategy_id] = DashboardServer70._EMPTY_STRATEGY_DATA()
...
def create_dashboard_70(host='0.0.0.0', port=5070) -> DashboardServer70:
    return DashboardServer70(host=host, port=port)
