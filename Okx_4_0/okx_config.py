    ...
    def _request(self, method, path, params=None, body=None):
        ...
        try:
            ...
            if res_json.get('code') != '0':
                print(f"[OKX API ERROR] {path} | Code: {res_json.get('code')} | Msg: {res_json.get('msg')}")
