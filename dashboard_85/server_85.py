...
class DashboardServer85:
    ...
    def __init__(self, port: int = 5085):
        self.host = '0.0.0.0'
        self.port = port
        ...
        self.app.config['SECRET_KEY'] = 'cts1-v85-secret-key'
    ...
    def _setup_routes(self):
        ...
        def api_status():
            ...
            if strategy_id:
                data = self._data.get(strategy_id, DashboardServer85._EMPTY_STRATEGY_DATA())
    ...
    def _setup_socketio(self):
        ...
        def handle_join(data):
            ...
            existing = self._data.get(strategy_id, DashboardServer85._EMPTY_STRATEGY_DATA())
    ...
    def register_strategy(self, strategy_id: str, display_name: "str | None" = None):
        if strategy_id not in self._data:
            self._data[strategy_id] = DashboardServer85._EMPTY_STRATEGY_DATA()
    ...
    def start(self, debug=False):
        print(f"\n{'='*60}")
        print(f"Dashboard 启动 (V8.5 版 {self.version})")
...
def create_dashboard_85(port=5085) -> DashboardServer85:
    return DashboardServer85(port=port)
